...
- `FlagCambioVendedor`: compara primer vendedor historico contra ultimo vendedor historico en `BITMovimientoInv`; excluye pedidos (`idTransaccionInv = 31`) por decision funcional de negocio.
